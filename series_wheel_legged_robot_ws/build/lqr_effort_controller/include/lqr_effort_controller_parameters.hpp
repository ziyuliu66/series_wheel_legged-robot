#pragma message("#include \"lqr_effort_controller_parameters.hpp\" is deprecated. Use #include <lqr_effort_controller/lqr_effort_controller_parameters.hpp> instead.")
...
#include "validate_lqr_effort_controller_parameters.hpp"
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("lqr_effort_controller"), prefix) {
    ...
    private:
      ...
      rclcpp::Logger logger_ = rclcpp::get_logger("lqr_effort_controller");
